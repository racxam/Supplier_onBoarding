		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsumoprocesstaskuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsumoprocesstaskuimodule-display": {
								"semanticObject": "comsumoprocesstaskuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sumo.processtaskuimodule",
									"url": sap.ui.require.toUrl("com/sumo/processtaskuimodule")
								}
							}
						}
					}
