sap.ui.define([
    ...
    function (Controller, JSONModel, MessageToast, MessageBox,Icon,Link, Fragment, Dialog, Button, Text) {
        "use strict";
        ...
        return Controller.extend("com.sumo.supplieronboarding.controller.form3", {
            ...
            onReadform: function () {
                ...
                var oFilter = new sap.ui.model.Filter('ID', 'EQ', '2f6a770f-7502-45e1-b2c5-4a78a8023c4a');  
            ...
            onReadAttachments: function() {
                var that = this;
                var oModel = this.getOwnerComponent().getModel();
                var oFilter = new sap.ui.model.Filter('Req_Supplier_ID', 'EQ', '2f6a770f-7502-45e1-b2c5-4a78a8023c4a');
